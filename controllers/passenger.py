...
from component_factory import get_passenger_service, get_cost_estimation_service, get_directions_service, \
    get_time_service
...
async def add_drive_order(order_request: PassengerDriveOrderRequest, passenger_service: PassengerService, cost_estimation: float) -> PassengerDriveOrder:
